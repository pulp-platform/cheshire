...
module cheshire_reg_top #(
  ...
  always_comb begin
    ...
    addr_hit[8] = (reg_addr == CHESHIRE_VGA_PARAMS_OFFSET);
  end
  ...
  assign vga_params_green_width_re = addr_hit[8] & reg_re & !reg_error;

  assign vga_params_blue_width_re = addr_hit[8] & reg_re & !reg_error;
