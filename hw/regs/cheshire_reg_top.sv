...
module cheshire_reg_top #(
  ...
  logic hw_features_sdio_qs;
  logic hw_features_sdio_re;
  ...
  prim_subreg_ext #(
    ...
    .re     (hw_features_sdio_re),
    .we     (1'b0),
    .wd     ('0),
    .d      (hw2reg.hw_features.sdio.d),
    .qre    (),
    .qe     (),
    .q      (),
    .qs     (hw_features_sdio_qs)
  );
  ...
  assign hw_features_sdio_re = addr_hit[20] & reg_re & !reg_error;
  ...
  always_comb begin
    ...
    unique case (1'b1)
      ...
      addr_hit[20]: begin
        ...
        reg_rdata_next[14] = hw_features_sdio_qs;
      end
