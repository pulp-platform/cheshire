...
package cheshire_pkg;
  ...
  function automatic config_pkg::cva6_user_cfg_t gen_cva6_cfg(cheshire_cfg_t cfg);
    ...
    ret.NrCachedRegionRules   = 4;   // CachedSPM, LLCOut, ExtCI, L1 ICache SPM;
    ret.CachedRegionAddrBase  = {SPM_BASE_ADDR, cfg.LlcOutRegionStart, CieBase, L1_ISPM_BASE_ADDR};
    ret.CachedRegionLength    = {SizeSpm,       SizeLlcOut,            cfg.Cva6ExtCieLength, L1_ISPM_SIZE};
    ret.DebugEn               = 1;
  ...
  localparam cheshire_cfg_t DefaultCfg = '{
    ...
    LlcAmoPostCut     : 1,
    LlcOutConnect     : 1,
    LlcOutRegionStart : 'h9000_0000,
    LlcOutRegionEnd   : 64'h1_1000_0000,
    LlcUserMsb        : 5,
    LlcUserLsb        : 2,
    LlcCachePartition : 0,
    LlcMaxPartition   : 16,
    ...
    SlinkMaxUniqIds   : 4,
    SlinkMaxClkDiv    : 1024,
    SlinkRegionStart  : 64'h1_1000_0000,
    SlinkRegionEnd    : 64'h2_1000_0000,
