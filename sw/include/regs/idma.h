...
// Configuration Register for the SMMU
#define IDMA_REG64_2D_SMMU_REG_OFFSET 0x4
#define IDMA_REG64_2D_SMMU_F_EXE_BIT 0
#define IDMA_REG64_2D_SMMU_F_USER_BIT 1
#define IDMA_REG64_2D_SMMU_F_BARE_BIT 2
#define IDMA_REG64_2D_SMMU_F_UPDATE_TLB_BIT 3

// High Word of the root of the page table
#define IDMA_REG64_2D_SMMU_ROOT_PT_H_REG_OFFSET 0x8

// Low Word of the root of the page table (needs to be page aligned)
#define IDMA_REG64_2D_SMMU_ROOT_PT_L_REG_OFFSET 0xc
...
// DMA Status
#define IDMA_REG64_2D_STATUS_0_REG_OFFSET 0x10
...
// DMA Status
#define IDMA_REG64_2D_STATUS_1_REG_OFFSET 0x14
...
// DMA Status
#define IDMA_REG64_2D_STATUS_2_REG_OFFSET 0x18
...
// DMA Status
#define IDMA_REG64_2D_STATUS_3_REG_OFFSET 0x1c
...
// DMA Status
#define IDMA_REG64_2D_STATUS_4_REG_OFFSET 0x20
...
// DMA Status
#define IDMA_REG64_2D_STATUS_5_REG_OFFSET 0x24
...
// DMA Status
#define IDMA_REG64_2D_STATUS_6_REG_OFFSET 0x28
...
// DMA Status
#define IDMA_REG64_2D_STATUS_7_REG_OFFSET 0x2c
...
// DMA Status
#define IDMA_REG64_2D_STATUS_8_REG_OFFSET 0x30
...
// DMA Status
#define IDMA_REG64_2D_STATUS_9_REG_OFFSET 0x34
...
// DMA Status
#define IDMA_REG64_2D_STATUS_10_REG_OFFSET 0x38
...
// DMA Status
#define IDMA_REG64_2D_STATUS_11_REG_OFFSET 0x3c
...
// DMA Status
#define IDMA_REG64_2D_STATUS_12_REG_OFFSET 0x40
...
// DMA Status
#define IDMA_REG64_2D_STATUS_13_REG_OFFSET 0x44
...
// DMA Status
#define IDMA_REG64_2D_STATUS_14_REG_OFFSET 0x48
...
// DMA Status
#define IDMA_REG64_2D_STATUS_15_REG_OFFSET 0x4c
...
// Next ID, launches transfer, returns 0 if transfer not set up properly.
#define IDMA_REG64_2D_NEXT_ID_0_REG_OFFSET 0x50

// Next ID, launches transfer, returns 0 if transfer not set up properly.
#define IDMA_REG64_2D_NEXT_ID_1_REG_OFFSET 0x54

// Next ID, launches transfer, returns 0 if transfer not set up properly.
#define IDMA_REG64_2D_NEXT_ID_2_REG_OFFSET 0x58

// Next ID, launches transfer, returns 0 if transfer not set up properly.
#define IDMA_REG64_2D_NEXT_ID_3_REG_OFFSET 0x5c

// Next ID, launches transfer, returns 0 if transfer not set up properly.
#define IDMA_REG64_2D_NEXT_ID_4_REG_OFFSET 0x60

// Next ID, launches transfer, returns 0 if transfer not set up properly.
#define IDMA_REG64_2D_NEXT_ID_5_REG_OFFSET 0x64

// Next ID, launches transfer, returns 0 if transfer not set up properly.
#define IDMA_REG64_2D_NEXT_ID_6_REG_OFFSET 0x68

// Next ID, launches transfer, returns 0 if transfer not set up properly.
#define IDMA_REG64_2D_NEXT_ID_7_REG_OFFSET 0x6c

// Next ID, launches transfer, returns 0 if transfer not set up properly.
#define IDMA_REG64_2D_NEXT_ID_8_REG_OFFSET 0x70

// Next ID, launches transfer, returns 0 if transfer not set up properly.
#define IDMA_REG64_2D_NEXT_ID_9_REG_OFFSET 0x74

// Next ID, launches transfer, returns 0 if transfer not set up properly.
#define IDMA_REG64_2D_NEXT_ID_10_REG_OFFSET 0x78

// Next ID, launches transfer, returns 0 if transfer not set up properly.
#define IDMA_REG64_2D_NEXT_ID_11_REG_OFFSET 0x7c

// Next ID, launches transfer, returns 0 if transfer not set up properly.
#define IDMA_REG64_2D_NEXT_ID_12_REG_OFFSET 0x80

// Next ID, launches transfer, returns 0 if transfer not set up properly.
#define IDMA_REG64_2D_NEXT_ID_13_REG_OFFSET 0x84

// Next ID, launches transfer, returns 0 if transfer not set up properly.
#define IDMA_REG64_2D_NEXT_ID_14_REG_OFFSET 0x88

// Next ID, launches transfer, returns 0 if transfer not set up properly.
#define IDMA_REG64_2D_NEXT_ID_15_REG_OFFSET 0x8c
...
#define IDMA_REG64_2D_DONE_ID_0_REG_OFFSET 0x90

// Get ID of finished transactions.
#define IDMA_REG64_2D_DONE_ID_1_REG_OFFSET 0x94

// Get ID of finished transactions.
#define IDMA_REG64_2D_DONE_ID_2_REG_OFFSET 0x98

// Get ID of finished transactions.
#define IDMA_REG64_2D_DONE_ID_3_REG_OFFSET 0x9c

// Get ID of finished transactions.
#define IDMA_REG64_2D_DONE_ID_4_REG_OFFSET 0xa0

// Get ID of finished transactions.
#define IDMA_REG64_2D_DONE_ID_5_REG_OFFSET 0xa4

// Get ID of finished transactions.
#define IDMA_REG64_2D_DONE_ID_6_REG_OFFSET 0xa8

// Get ID of finished transactions.
#define IDMA_REG64_2D_DONE_ID_7_REG_OFFSET 0xac

// Get ID of finished transactions.
#define IDMA_REG64_2D_DONE_ID_8_REG_OFFSET 0xb0

// Get ID of finished transactions.
#define IDMA_REG64_2D_DONE_ID_9_REG_OFFSET 0xb4

// Get ID of finished transactions.
#define IDMA_REG64_2D_DONE_ID_10_REG_OFFSET 0xb8

// Get ID of finished transactions.
#define IDMA_REG64_2D_DONE_ID_11_REG_OFFSET 0xbc

// Get ID of finished transactions.
#define IDMA_REG64_2D_DONE_ID_12_REG_OFFSET 0xc0

// Get ID of finished transactions.
#define IDMA_REG64_2D_DONE_ID_13_REG_OFFSET 0xc4

// Get ID of finished transactions.
#define IDMA_REG64_2D_DONE_ID_14_REG_OFFSET 0xc8
