...
#define CHESHIRE_HW_FEATURES_UART_BIT 0
#define CHESHIRE_HW_FEATURES_SPI_HOST_BIT 1
#define CHESHIRE_HW_FEATURES_I2C_BIT 2
#define CHESHIRE_HW_FEATURES_DMA_BIT 3
#define CHESHIRE_HW_FEATURES_SERIAL_LINK_BIT 4
#define CHESHIRE_HW_FEATURES_VGA_BIT 5
#define CHESHIRE_HW_FEATURES_DRAM_BIT 6

// VGA hardware parameters
#define CHESHIRE_VGA_PARAMS_REG_OFFSET 0x20
