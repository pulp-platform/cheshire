...
#define CHESHIRE_HW_FEATURES_BUS_ERR_BIT 12
...
#define CHESHIRE_ETH_CLK_DIV_EN_REG_OFFSET 0x60
#define CHESHIRE_ETH_CLK_DIV_EN_ETH_CLK_DIV_EN_BIT 0

// Ethernet clock divider value
#define CHESHIRE_ETH_CLK_DIV_VALUE_REG_OFFSET 0x64
#define CHESHIRE_ETH_CLK_DIV_VALUE_ETH_CLK_DIV_VALUE_MASK 0xfffff
#define CHESHIRE_ETH_CLK_DIV_VALUE_ETH_CLK_DIV_VALUE_OFFSET 0
#define CHESHIRE_ETH_CLK_DIV_VALUE_ETH_CLK_DIV_VALUE_FIELD \
  ((bitfield_field32_t) { .mask = CHESHIRE_ETH_CLK_DIV_VALUE_ETH_CLK_DIV_VALUE_MASK, .index = CHESHIRE_ETH_CLK_DIV_VALUE_ETH_CLK_DIV_VALUE_OFFSET })
