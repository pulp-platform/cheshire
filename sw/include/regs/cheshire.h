...
#define CHESHIRE_HW_FEATURES_UART_BIT 1
#define CHESHIRE_HW_FEATURES_SPI_HOST_BIT 2
#define CHESHIRE_HW_FEATURES_I2C_BIT 3
#define CHESHIRE_HW_FEATURES_DMA_BIT 4
#define CHESHIRE_HW_FEATURES_SERIAL_LINK_BIT 5
#define CHESHIRE_HW_FEATURES_VGA_BIT 6
