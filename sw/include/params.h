...
static const uint64_t __BOOT_ZSL_TYPE_GUID [2] = {
    0x4CE4FD950269B26AUL, 0x622C41011494CF98UL
};

// GUID of flattened device tree blob
static const uint64_t __BOOT_DTB_TYPE_GUID [2] = {
    0x42DE2AEFBA442F61UL, 0x9DCB3A5DD7E43392UL
};

// GUID of firmware partition we boot into
static const uint64_t __BOOT_FW_TYPE_GUID [2] = {
    0x4B0D3F5B99EC86DAUL, 0x59F8A5CFBAC44B8FUL
};
