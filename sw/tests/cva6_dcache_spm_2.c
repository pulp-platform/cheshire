...
volatile data_t *spm_data_1 = (volatile data_t *)&__l1_dspm_base_addr__ + 0 * N;
volatile data_t *spm_data_2 = (volatile data_t *)&__l1_dspm_base_addr__ + 1 * N;

data_t data_1[N];
data_t data_2[N];

void axpy(data_t a, volatile data_t *x, volatile data_t *y, data_t n) {
