...
int gpt_boot_part_else_raw(gpt_read_t read, void *priv, void *code_buf, uint64_t max_lbas,
    ...
    *reg32(&__base_regs, CHESHIRE_CHESHIRE_REGS_SCRATCH_0_REG_OFFSET) = (uintptr_t)((void *)read) | 1;
    *reg32(&__base_regs, CHESHIRE_CHESHIRE_REGS_SCRATCH_1_REG_OFFSET) = (uintptr_t)priv;
    *reg32(&__base_regs, CHESHIRE_CHESHIRE_REGS_SCRATCH_3_REG_OFFSET) = (uintptr_t)gprw(0);
    // Invoke code
