...
RISCV_FLAGS   ?= -march=rv64gc_zifencei -mabi=lp64d -O2 -Wall -static -ffunction-sections -fdata-sections -Wdate-time -frandom-seed=testo
RISCV_CCFLAGS ?= $(RISCV_FLAGS) -mcmodel=medany -mexplicit-relocs -fno-builtin -fverbose-asm -pipe
