...
CHS_SW_TEST_L2_DUMP     = $(CHS_SW_TEST_SRCS_S:.S=.l2.dump)   $(CHS_SW_TEST_SRCS_C:.c=.l2.dump)
...
chs-sw-tests: $(CHS_SW_TEST_DRAM_DUMP) $(CHS_SW_TEST_SPM_DUMP) $(CHS_SW_TEST_L2_DUMP) $(CHS_SW_TEST_SPM_ROMH) $(CHS_SW_TEST_SPM_GPTH)
