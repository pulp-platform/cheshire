...
CHS_SW_TEST_DRAM_MEMH  	= $(CHS_SW_TEST_SRCS_S:.S=.dram.memh) $(CHS_SW_TEST_SRCS_C:.c=.dram.memh)
...
CHS_SW_TESTS = $(CHS_SW_TEST_DRAM_DUMP) $(CHS_SW_TEST_DRAM_MEMH) $(CHS_SW_TEST_SPM_DUMP) $(CHS_SW_TEST_SPM_ROMH) $(CHS_SW_TEST_SPM_GPTH)
