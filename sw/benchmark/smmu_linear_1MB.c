...
// This test copies 1MB a linear data
// To work properly the dma needs to be configured as 1D!
...
int main(void) {
    ...
    // Könnte mit rand generaiert werden --> Attention if Overlapping Space
    transfer_t tf;
