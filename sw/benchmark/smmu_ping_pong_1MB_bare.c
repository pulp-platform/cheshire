...
int main(void) {
    ...
    sys_dma_blk_memcpy((uintptr_t)(void *) tf_pp.pa_src, (uintptr_t)(void *) tf.pa_src, 262144);

    // Start tracking how much we copied
    void * buffer_src_ptr = tf.pa_src + 262144;
    void * buffer_dst_ptr = tf.pa_dst;
    ...
    sys_dma_memcpy((uintptr_t)(void *) buffer_dst_ptr, (uintptr_t)(void *) tf_pp.pa_src, 262144);
    sys_dma_blk_memcpy((uintptr_t)(void *) tf_pp.pa_dst, (uintptr_t)(void *) (buffer_src_ptr), 262144);
    ...
    sys_dma_memcpy((uintptr_t)(void *) buffer_dst_ptr, (uintptr_t)(void *) tf_pp.pa_dst, 262144);
    sys_dma_blk_memcpy((uintptr_t)(void *) tf_pp.pa_src, (uintptr_t)(void *) (buffer_src_ptr), 262144);
    buffer_src_ptr = buffer_src_ptr + 262144;
    buffer_dst_ptr = buffer_dst_ptr + 262144;
