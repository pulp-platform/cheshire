...
# 50 MHz system Clock
create_generated_clock -name soc_clk -divide_by 4 -source [get_pins i_sys_clk_div/clk_i] [get_pins i_sys_clk_div/clk_o]
...
set_max_delay -from [get_pins i_rstgen_main/i_rstgen_bypass/synch_regs_q_reg\[3\]/C] [expr 0.7*5]
