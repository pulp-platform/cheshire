...
if {[info exists ::env(XILINX_ROUTED_DCP)] && [file exists $::env(XILINX_ROUTED_DCP)]} {
  set_property incremental_checkpoint $ $::env(XILINX_ROUTED_DCP) [get_runs impl_1]
}
...
if {[info exists ::env(CHECK_TIMING)] && $::env(XILINX_CHECK_TIMING)==1} {
...
if {[info exists ::env(EXPORT_SDF)] && $::env(XILINX_EXPORT_SDF)==1} {
