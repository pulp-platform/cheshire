...
${VCS_BIN} ${flags} -CFLAGS "-std=c++17 -I/scratch/ga25f6/cheshire/sw/deps/riscv-isa-sim/install/include"  -L/scratch/ga25f6/cheshire/sw/deps/riscv-isa-sim/install/lib -lfesvr ../src/elfloader.cpp ${TESTBENCH} | tee elaborate.log
